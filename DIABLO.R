...
save_and_plot("figures/final_diablo.svg", plotDiablo, final.diablo.model, ncomp = 1)

# plotIndiv(final.diablo.model, ind.names = FALSE, legend = TRUE, 
#           title = 'DIABLO Sample Plots')
save_and_plot("figures/diablo_individuals.svg", plotIndiv,
...
save_and_plot("figures/diablo_arrow.svg", plotArrow, final.diablo.model,
...
save_and_plot("figures/diablo_variables.svg", plotVar, final.diablo.model,
...
save_and_plot("figures/diablo_circos.svg", circosPlot,
...
save_and_plot("figures/diablo_relevance_network.svg", network,
              final.diablo.model, blocks = c(1,2,3), cutoff = 0.4,
...
save_and_plot("figures/diablo_loading_vectors.svg", plotLoadings,
              final.diablo.model, comp = 2, contrib = 'max', method = 'median')

# cimDiablo(final.diablo.model)
save_and_plot("figures/diablo_cim.svg", cimDiablo, final.diablo.model)
